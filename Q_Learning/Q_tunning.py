...
from utils.Utils import calculate_standard_deviation, q_table_to_array, calculate_time, plot_diff_values, \
    plot_q_convergence, plot_average_rewards, plot_success_rate
...
if __name__ == "__main__":
    ...
    if TASK == TASK_LIST[0]:
        ...
        _, _, _, _, Episode_Time_1, Q_Value_Per_Episodes_Diff_1, min_episode_1, q_convergence_list_1, steps_1, SUCCESS_RATE_1, overall_success_rate_1, Reward_List_1 = Q_learning.train(NUM_EPISODES)
        Q_learning.gamma = 0.4
        _, _, _, _, Episode_Time_2, Q_Value_Per_Episodes_Diff_2, min_episode_2, q_convergence_list_2, steps_2, SUCCESS_RATE_2, overall_success_rate_2, Reward_List_2 = Q_learning.train(NUM_EPISODES)
        Q_learning.gamma = 0.6
        _, _, _, _, Episode_Time_3, Q_Value_Per_Episodes_Diff_3, min_episode_3, q_convergence_list_3, steps_3, SUCCESS_RATE_3, overall_success_rate_3, Reward_List_3 = Q_learning.train(NUM_EPISODES)
        Q_learning.gamma = 0.8
        _, _, _, _, Episode_Time_4, Q_Value_Per_Episodes_Diff_4, min_episode_4, q_convergence_list_4, steps_4, SUCCESS_RATE_4, overall_success_rate_4, Reward_List_4 = Q_learning.train(NUM_EPISODES)
        ...
        plot_average_rewards(METHOD_NAME, METHOD_PATH, Reward_List, label_learning_rate)
        plot_success_rate(METHOD_NAME, METHOD_PATH, SMOOTH, Success_Rate_List, overall_success_rate_List, label_learning_rate)
    elif TASK == TASK_LIST[2]:
        label_learning_rate = ['greedy policy:0.0(exploitation)', 'greedy policy:0.2', 'greedy policy:0.4', 'greedy policy:0.6', 'greedy policy:1.0(exploration)']
        Q_learning.epsilon = 0.0
        _, _, _, _, Episode_Time_1, Q_Value_Per_Episodes_Diff_1, min_episode_1, q_convergence_list_1, steps_1, SUCCESS_RATE_1, overall_success_rate_1, Reward_List_1 = Q_learning.train(NUM_EPISODES)
        Q_learning.epsilon = 0.2
        _, _, _, _, Episode_Time_2, Q_Value_Per_Episodes_Diff_2, min_episode_2, q_convergence_list_2, steps_2, SUCCESS_RATE_2, overall_success_rate_2, Reward_List_2 = Q_learning.train(NUM_EPISODES)
        Q_learning.epsilon = 0.4
        _, _, _, _, Episode_Time_3, Q_Value_Per_Episodes_Diff_3, min_episode_3, q_convergence_list_3, steps_3, SUCCESS_RATE_3, overall_success_rate_3, Reward_List_3 = Q_learning.train(NUM_EPISODES)
        Q_learning.epsilon = 0.6
        _, _, _, _, Episode_Time_4, Q_Value_Per_Episodes_Diff_4, min_episode_4, q_convergence_list_4, steps_4, SUCCESS_RATE_4, overall_success_rate_4, Reward_List_4 = Q_learning.train(NUM_EPISODES)
        Q_learning.epsilon = 1.0
        _, _, _, _, Episode_Time_5, Q_Value_Per_Episodes_Diff_5, min_episode_5, q_convergence_list_5, steps_5, SUCCESS_RATE_5, overall_success_rate_5, Reward_List_5 = Q_learning.train(NUM_EPISODES)
        Q_Value_Diff_List = [Q_Value_Per_Episodes_Diff_1, Q_Value_Per_Episodes_Diff_2, Q_Value_Per_Episodes_Diff_3, Q_Value_Per_Episodes_Diff_4, Q_Value_Per_Episodes_Diff_5]
        min_episode_List = [min_episode_1, min_episode_2, min_episode_3, min_episode_4, min_episode_5]
        Q_Convergence_List = [q_convergence_list_1, q_convergence_list_2, q_convergence_list_3, q_convergence_list_4, q_convergence_list_5]
        Reward_List = [Reward_List_1, Reward_List_2, Reward_List_3, Reward_List_4, Reward_List_5]
